...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "username" TEXT,
    "hasOrganization" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Organization" (
    ...
    "subscriptionStatus" TEXT NOT NULL DEFAULT 'inactive',
    "currentPlan" TEXT DEFAULT 'basic',
    "trialEndsAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Feedback_organizationId_sentiment_idx" ON "Feedback"("organizationId", "sentiment");

-- CreateIndex
CREATE INDEX "Feedback_organizationId_urgency_idx" ON "Feedback"("organizationId", "urgency");

-- CreateIndex
CREATE INDEX "Feedback_organizationId_category_idx" ON "Feedback"("organizationId", "category");
