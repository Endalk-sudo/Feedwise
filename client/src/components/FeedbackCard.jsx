 ...
 */
const FeedbackCard = ({ feedbackText, date, category, rating ,sentiment }) => {
  const sentimentColors = [
  { sentiment: 'positive', color: '#4CAF50' },
  { sentiment: 'negative', color: '#F44336' },
  { sentiment: 'neutral', color: '#9E9E9E' },
  { sentiment: 'mixed', color: '#FF9800' }
];

  const sentimentColor = sentimentColors.find(s => s.sentiment.toLowerCase() === sentiment.toLowerCase())?.color || '#9E9E9E';
  ...
  return (
    <div className="feedback-card">
      ...
      <div className="feedback-meta-data">
        <div className="meta-item sentiment-badge" style={{ border: `1px solid ${sentimentColor}`, color: sentimentColor }}>
